...
import com.shmedo.lib.core.util.jsonhelper.NullBooleanAdapter;
import com.shmedo.lib.core.util.jsonhelper.NullDoubleAdapter;
import com.shmedo.lib.core.util.jsonhelper.NullIntAdapter;
import com.shmedo.lib.core.util.jsonhelper.NullStringAdapter;
 ...
 * Time: 15:34
 */
public class MyMoshiConverter implements JsonConverter {
    ...
    private MyMoshiConverter(Moshi moshi, boolean lenient, boolean failOnUnknown, boolean serializeNulls, MediaType contentType) {
        this.moshi = moshi;
     ...
     * @return MoshiConverter
     */
    public static MyMoshiConverter create(Moshi moshi) {
     ...
     * @return MoshiConverter
     */
    public static MyMoshiConverter create(Moshi moshi, MediaType contentType) {
        if (moshi == null) throw new NullPointerException("moshi == null");
        return new MyMoshiConverter(moshi, false, false, false, contentType);
    }
     ...
     * @return MoshiConverter
     */
    public MyMoshiConverter asLenient() {
        return new MyMoshiConverter(moshi, true, failOnUnknown, serializeNulls, contentType);
    }
     ...
     * @return MoshiConverter
     */
    public MyMoshiConverter failOnUnknown() {
        return new MyMoshiConverter(moshi, lenient, true, serializeNulls, contentType);
    }
     ...
     * @return MoshiConverter
     */
    public MyMoshiConverter withNullSerialization() {
        return new MyMoshiConverter(moshi, lenient, failOnUnknown, true, contentType);
    }
