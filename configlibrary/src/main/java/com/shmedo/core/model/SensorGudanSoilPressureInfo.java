 ...
 * 文件名:   SensorGudanSoilPressureInfo
 * 创建者:   dpc
 * 创建时间:  2019/5/8 14:17
 * 描述：    传感器类型为 葛南土压力盒 52
 */

public class SensorGudanSoilPressureInfo implements SensorParameter {
    ...
    @Override public SensorType getSensorType() {
        return SensorType.GUDAN_SOIL_PRESSURE;
    }


    @Override public String toString() {
        return "SensorGudanSoilPressureInfo{" +
