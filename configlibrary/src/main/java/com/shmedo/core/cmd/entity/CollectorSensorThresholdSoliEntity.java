 ...
 * 设置采集器接入传感器触发阈值————目前仅适用于墒情采集器_参数
 */
public class CollectorSensorThresholdSoliEntity implements Validater {
    ...
    public CollectorSensorThresholdSoliEntity(String collectorModel, String address, String humidity, String salinity, String temperature) {
