 ...
 * 设置GPS定位参数
 */
public class SettingGPSPositionEntity implements Validater{

    private String sensitivity;
    private int accuracy;


    public SettingGPSPositionEntity(String sensitivity) {
        this.sensitivity = sensitivity;
    }

    public SettingGPSPositionEntity(String sensitivity, int accuracy) {
        this.sensitivity = sensitivity;
