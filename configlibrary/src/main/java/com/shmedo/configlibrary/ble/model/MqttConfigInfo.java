...
public class MqttConfigInfo implements Serializable {
    ...
    public String getCommunicationProtocol() {
        return TextUtils.isEmpty(communicationProtocol) ? "" : communicationProtocol;
    }
    ...
    public String getDataPlatformAddress() {
        return TextUtils.isEmpty(dataPlatformAddress) ? "" : dataPlatformAddress;
    }
    ...
    public String getKeepAliveValue() {
        return TextUtils.isEmpty(keepAliveValue) ? "" : keepAliveValue;
    }
    ...
    public String getDeviceSn() {
        return TextUtils.isEmpty(deviceSn) ? "" : deviceSn;
    }
    ...
    public String getRegisterCode() {
        return TextUtils.isEmpty(registerCode) ? "" : registerCode;
    }
    ...
    public String getRegisterPlatformAddress() {
        return TextUtils.isEmpty(registerPlatformAddress) ? "" : registerPlatformAddress;
    }
    ...
    public String getMqttDeviceId() {
        return TextUtils.isEmpty(mqttDeviceId) ? "" : mqttDeviceId;
    }
    ...
    public String getMqttUsername() {
        return TextUtils.isEmpty(mqttUsername) ? "" : mqttUsername;
    }
    ...
    public String getMqttPassword() {
        return TextUtils.isEmpty(mqttPassword) ? "" : mqttPassword;
    }
