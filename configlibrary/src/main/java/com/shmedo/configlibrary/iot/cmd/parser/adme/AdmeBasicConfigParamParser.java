 ...
 * 描述：     解析ADME基础配置参数
 */
public class AdmeBasicConfigParamParser implements IOTResultParser<AdmeBasicConfigParam> {
    @Override
    public AdmeBasicConfigParam parse(String result) {
        AdmeBasicConfigParam info = new AdmeBasicConfigParam();
        try {
