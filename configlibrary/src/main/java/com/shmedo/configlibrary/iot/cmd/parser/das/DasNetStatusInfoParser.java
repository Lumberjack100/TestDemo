 ...
 */
public class DasNetStatusInfoParser implements IOTResultParser<DasNetStatusInfo> {
    @Override
    public DasNetStatusInfo parse(String result) {
        DasNetStatusInfo info = null;
        try {
            ...
            info = GsonFactory.getGson().fromJson(status, DasNetStatusInfo.class);
