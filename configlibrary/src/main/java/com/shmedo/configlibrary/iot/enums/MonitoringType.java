...
//    CRACK_GAUGE("101", "地表裂缝计"),
    ...
    MonitoringType(String code, String description) {
        this.code = code;
    ...
    public static MonitoringType valueByCode(String code) {
        ...
        for (MonitoringType sensorType : MonitoringType.values()) {
    ...
    public static MonitoringType valueByDesc(String desc) {
