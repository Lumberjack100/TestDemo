...
import com.shmedo.configlibrary.iot.cmd.parser.adme.AdmeBrakePadControlInfoParser;
...
import com.shmedo.configlibrary.iot.cmd.parser.das.McuAddressParser;
...
public class IOTParseManager {
    ...
    private void registerParse() {
        List<Class> clazzes = Arrays.asList(new Class[]{
                ...
                AdmeBrakePadControlInfoParser.class,
