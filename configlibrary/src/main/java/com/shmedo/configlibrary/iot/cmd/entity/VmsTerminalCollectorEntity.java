...
public class VmsTerminalCollectorEntity implements Validater {
    ...
    public String toString() {
        ...
        if (!TextUtils.isEmpty(reptgap)) {
            stringBuilder.append("reptgap=" + reptgap);
            stringBuilder.append("&");
        }
        if (!TextUtils.isEmpty(repttype)) {
            stringBuilder.append("repttype=" + repttype);
            stringBuilder.append("&");
        }
        ...
        if (!TextUtils.isEmpty(filternum)) {
            stringBuilder.append("filternum=" + filternum);
            stringBuilder.append("&");
        }
        ...
        if (!TextUtils.isEmpty(waitgap)) {
            stringBuilder.append("waitgap=" + waitgap);
            stringBuilder.append("&");
        }
