...
public class DateTimePickerView extends PickerViewGroup {
    ...
    private void addFlags(int field) {
        switch (field) {
            ...
            case FIELD_DAY:
                ...
                break;
            case FIELD_DATE:
                if (type == TYPE_DATE_HOUR_MINUTE|| type == TYPE_HOUR_MINUTE) {
                    tryPreserveValuesFlag |= PRESERVE_FLAG_HOUR;
    ...
    private void configurePickerViews() {
        ...
        settlePickerView(hourPickerView, type == TYPE_DATE_HOUR_MINUTE||type==TYPE_HOUR_MINUTE);
        settlePickerView(minutePickerView, type == TYPE_DATE_HOUR_MINUTE ||type==TYPE_HOUR_MINUTE);
...
//                            return endDate.get(Calendar.MINUTE)  - stepOffset() ;
//                        }
//                        return 60  - stepOffset();
//                    }
//
//                    @Override
//                    public CalendarField getItem(int index) {
//                        return new CalendarField(FIELD_MINUTE, (index + stepOffset()));
//                    }
//                });
                minutePickerView.setAdapter(new PickerView.Adapter<CalendarField>() {
