...
public class WheelView extends View
{
    ...
    private void onDrawItemBefor()
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            if (childView instanceof IWheelSubView)
            {
                if (isFound)
                {
                    ((IWheelSubView) childView).onDrawBefor(false);
                }
                else
                {
                    if (currentItem == 0)
                    {
                        ((IWheelSubView) childView).onDrawBefor(true);
                        isFound = true;
                    }
                    else if (i == visibleItems / 2)
                    {
                        ((IWheelSubView) childView).onDrawBefor(true);
                        isFound = true;
                    }
