 ...
 * 描述：     解析通用的设置指令响应结果
 */
class OldCommonSettingCmdResultParserOld :
    OldIOTResultParser<CommonSettingCmdResult> {
    ...
    override fun commandType(): IOTCommandType {
        return IOTCommandType.COMMON_SETTING_COMMAND
    }

    companion object {
        @JvmStatic
        val instance = OldCommonSettingCmdResultParserOld()
    }
}