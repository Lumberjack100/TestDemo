...
data class CommonCurrentStateInfo(
    val ext_power_volt: String = "", //外接电源电压
    val inner_power_volt: String = "", //内部电源电压
    val temp: String = "", //设备内部环境温度，单位摄氏度
    val humidity: String = "", //设备内部湿度，单位 RH%
    val temp_out: String = "", //设备外部环境温度，单位摄氏度
    val humidity_out: String = "", //设备外部环境湿度，单位RH%
    @Json(name = "4g_signal")
    ...
    val solar_volt: String = "", //太阳能板电压,单位V
    val battery_volt: String = "", //蓄电池电压，单位V
    val supply_power: String = "", //近12小时补充功率，单位千瓦时
    val consume_power: String = "", //近12小时消耗功率，单位千瓦时
    val time: String = "",
    val onlinetime: String = "--",
    val solar_current: String = "",
    val battery_current: String = "",
    val mag: String = "",
    @Json(name = "IMEI")
    val iMEI: String = "", //IMEI卡号
    @Json(name = "CCID")
    val cCID: String = "", //物联网卡号
    val work_current: String = "", //设备工作电流，单位A
    val volt_percent: String = "",
    @Json(name = "X_Angle")
    val x_Angle: String = "", //X倾角
    @Json(name = "Y_Angle")
    val y_Angle: String = "", //Y倾角
    @Json(name = "Z_Angle")
    val z_Angle: String = "", //Z倾角
    @Json(name = "SN")
    val sN: String = "", //设备SN号
    @Json(name = "eMMC Free")
