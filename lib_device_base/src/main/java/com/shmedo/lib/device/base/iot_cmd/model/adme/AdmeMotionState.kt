 ...
 * 描述：     ADME的运行状态
 */
data class AdmeMotionState(
    var motionstate: String = "",//运动状态(0:管口停止，1:管底停止，2:管口测量，3:管口测试，4:上拉测量，5:上拉测试，6:下放测量，7:下放测试)
    var inctiondis: String = "", //测斜仪运动距离或实时下放距离或管底等待时的距离
    ...
    var motorinfo: String = "", //电机运动信息
    var measpoint: String = "", //测点信息 (1|20.5  表示第一个测量点：20.5米)
    var waittime: String = "", //管底等待时间
)