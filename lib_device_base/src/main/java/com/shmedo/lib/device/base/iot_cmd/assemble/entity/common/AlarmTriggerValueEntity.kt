...
data class AlarmTriggerValueEntity(
    ...
    val devlevel1: String = IOTConstants.NULL_KEY,//一级报警位移阈值  默认40
    val devlevel2: String = IOTConstants.NULL_KEY,//二级报警位移阈值  默认20
    val devlevel3: String = IOTConstants.NULL_KEY,//三级报警位移阈值  默认10
    val devlevel4: String = IOTConstants.NULL_KEY,//四级报警位移阈值  默认5
) {
