...
import com.shmedo.lib.device.base.iot_cmd.model.das.DasFixedPointReportInfo
 ...
 * 描述：     解析DAS  定时定点上报参数
 */
class DasFixedPointReportInfoParserOld :
    OldIOTResultParser<DasFixedPointReportInfo?> {
