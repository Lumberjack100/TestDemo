...
class DasIOSensorInfoParser : IOTCommandParser<DasIOSensorInfo> {
    ...
    override fun parseInstance(keyValueMap: Map<String, String>): DasIOSensorInfo {
    ...
    override fun commandType(): IOTCommandType = IOTCommandType.DAS_MD_GET_IO_SENSOR_INFO
}