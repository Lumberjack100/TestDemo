...
public class Constants {
    ...
    public static final int BT_CONNECT=0;
    public static final int BT_DISCONNECTED=1;
    public static final int BT_MESSAGE_WRITE_SUCCESS=2;
    public static final int BT_MESSAGE_WRITE_FAIL=3;
    public static final int BT_WRITE_TIME_OUT=4;
    public static final int VERIFY_RESULT=5;
    public static final int VERIFY_SUCESS=6;
    public static final int MESSAGE_RESPONSE_TIME_OUT=7;
    public static final int REFRESH_RUN_STATE=8;
    public static final int MESSAGE_RESPONSE_SAVE_SETTINGS_SUCCESS=9;
    public static final int BT_REQUEST_MTU_FAIL=10;
    public static final int BT_SERVICE_FIND_FAIL=11;
    public static final int BT_CHARACTERISTICS_FIND_FAIL=12;
    public static final int BT_ENABLE_READ_SUCCESS=13;
    public static final int BT_ENABLE_READ_FAIL=14;
