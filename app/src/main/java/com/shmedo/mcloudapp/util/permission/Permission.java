...
/**
 * <p>Permissions.</p>
 * Created by dpc Yan on 2017/8/4.
 */
            ...
            switch (permission) {
                ...
                case com.yanzhenjie.permission.runtime.Permission.PROCESS_OUTGOING_CALLS: {
                    ...
                    int messageId = Build.VERSION.SDK_INT >= Build.VERSION_CODES.P ?
                        com.yanzhenjie.permission.R.string.permission_name_call_log : com.yanzhenjie.permission.R.string.permission_name_phone;
                ...
                case com.yanzhenjie.permission.runtime.Permission.ACTIVITY_RECOGNITION: {
                    String message = context.getString(com.yanzhenjie.permission.R.string.permission_name_activity_recognition);
                    if (!textList.contains(message)) {
                        textList.add(message);
                    }
                    break;
