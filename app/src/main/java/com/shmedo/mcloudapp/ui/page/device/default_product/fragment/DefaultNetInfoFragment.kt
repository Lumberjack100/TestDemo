 ...
 * 5. 支持4G和蓝牙两种通讯方式
 */
class DefaultNetInfoFragment : OptimizedBaseDeviceStatusInfoStyleFragment() {
    ...
    override fun <T> initStatusInfo(content: T) {
        launchWithViewLifecycle {
            try {
                ...
                if (stateInfo.dataCenter1 != IOTConstants.NULL_KEY && stateInfo.dataCenter2 != IOTConstants.NULL_KEY && stateInfo.dataCenter3 != IOTConstants.NULL_KEY && stateInfo.dataCenter4 != IOTConstants.NULL_KEY) {
                    groupList.add(GapItem(height = ConvertUtils.dp2px(12f)))
                    groupList.add(DeviceStatusInfoGroupItem("数据链路"))
                    val status1 = stateInfo.dataCenter1.compareAndReturn(
                        "0",
                        "未启用",
                        stateInfo.dataCenter1.compareAndReturn("1", "已连接", "未连接")
                    )
                    DeviceStatusInfoProcessor.addDeviceStatusInfoBasicItemFromString(
                        groupList,
                        name = "数据链路1",
                    ...
                    val status2 = stateInfo.dataCenter2.compareAndReturn(
                        "0",
                        "未启用",
                        stateInfo.dataCenter2.compareAndReturn("1", "已连接", "未连接")
                    )
                    DeviceStatusInfoProcessor.addDeviceStatusInfoBasicItemFromString(
                        groupList,
                        name = "数据链路2",
                    ...
                    val status3 = stateInfo.dataCenter3.compareAndReturn(
                        "0",
                        "未启用",
                        stateInfo.dataCenter3.compareAndReturn("1", "已连接", "未连接")
                    )
                    DeviceStatusInfoProcessor.addDeviceStatusInfoBasicItemFromString(
                        groupList,
                        name = "数据链路3",
                    ...
                    val status4 = stateInfo.dataCenter4.compareAndReturn(
                        "0",
                        "未启用",
                        stateInfo.dataCenter4.compareAndReturn("1", "已连接", "未连接")
                    )
                    DeviceStatusInfoProcessor.addDeviceStatusInfoBasicItemFromString(
                        groupList,
                        name = "数据链路4",
