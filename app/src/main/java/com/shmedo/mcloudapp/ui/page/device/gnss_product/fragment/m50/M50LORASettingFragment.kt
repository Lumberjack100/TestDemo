...
import com.shmedo.mcloudapp.databinding.FragmentM50LoraSettingBinding
import com.shmedo.mcloudapp.extensions.nav
import com.shmedo.mcloudapp.extensions.registerOnBackPressedDispatcher
import com.shmedo.mcloudapp.ui.page.device.OptimizedBaseIOTDeviceFragment
import com.shmedo.mcloudapp.ui.viewmodel.state.M50LORASettingViewModel
import com.shmedo.mcloudapp.ui.viewmodel.state.ToolbarViewModel
import org.koin.android.ext.android.inject

class M50LORASettingFragment : OptimizedBaseIOTDeviceFragment() {
    private lateinit var binding: FragmentM50LoraSettingBinding
    private val toolbarViewModel: ToolbarViewModel by viewModels()
    private val mStates: M50LORASettingViewModel by viewModels()
    ...
    override fun getDataBindingConfig(): DataBindingConfig {
        return DataBindingConfig(
            R.layout.fragment_m50_lora_setting,
            BR.stateVM,
            mStates
        )
    ...
    override fun initView(savedInstanceState: Bundle?) {
        binding = getBinding() as FragmentM50LoraSettingBinding
