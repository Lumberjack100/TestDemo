...
import com.shmedo.mcloudapp.databinding.FragmentNewUniversalDataCenterParamBinding
 ...
 *
 */
class NewUniversalDataCenterParamFragment : OptimizedBaseIOTDeviceFragment() {
    private lateinit var binding: FragmentNewUniversalDataCenterParamBinding
    ...
    override fun getDataBindingConfig(): DataBindingConfig {
        return DataBindingConfig(
            R.layout.fragment_new_universal_data_center_param,
            BR.stateVM,
            mStates
        )
    ...
    override fun initView(savedInstanceState: Bundle?) {
        binding = getBinding() as FragmentNewUniversalDataCenterParamBinding
    ...
    private fun initDataCenterParam(data: DataCenterInfo) {
        try {
            ...
            mStates.isRegisterVisible.set(mStates.platformType.get() != NewDataCenterPlatform.CHONGQING_DISASTER_PLATFORM.getPlatFormName())

            //SL651 水文协议参数
            mStates.stationType.set(SL651StationType.valueByCode(data.type_code).getStationName())//测站分类
            ...
            XPopup.Builder(context)
                ...
                .asBottomList(
                    ...
                    { position, text ->
                        ...
                        mStates.isRegisterVisible.set(text != NewDataCenterPlatform.CHONGQING_DISASTER_PLATFORM.getPlatFormName())
                        // 加载选中平台的默认参数
