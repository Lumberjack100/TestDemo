...
class MR702RS485Port3AcousticOpticalAlarmParamFragment : BaseIOTDeviceFragment() {
    ...
    private fun initSaveCommand() {
        ...
        val entity2 = MRAlarmModuleParamEntity(
            ...
            voiceindex1 = mStates.generateVoiceCommand("255", mStates.waterLevelVoiceIndex1.get()),
            voiceindex2 = mStates.generateVoiceCommand("255", mStates.waterLevelVoiceIndex2.get()),
            voiceindex3 = mStates.generateVoiceCommand("255", mStates.waterLevelVoiceIndex3.get()),
            voiceindex4 = mStates.generateVoiceCommand("255", mStates.waterLevelVoiceIndex4.get()),
