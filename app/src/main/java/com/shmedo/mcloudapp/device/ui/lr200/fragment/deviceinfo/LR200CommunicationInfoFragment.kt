                ...
                "数据状态" -> {
                    columnCellDataList.add(
                        CommunicationDataCellModel(
                            mData = if (commonCurrentStateInfo.dataCenter1 == 0) "未接入" else if (commonCurrentStateInfo.dataCenter1 == 1) "在线" else "离线",
                    ...
                    columnCellDataList.add(
                        CommunicationDataCellModel(
                            mData = if (commonCurrentStateInfo.dataCenter2 == 0) "未接入" else if (commonCurrentStateInfo.dataCenter2 == 1) "在线" else "离线",
                    ...
                    columnCellDataList.add(
                        CommunicationDataCellModel(
                            mData = if (commonCurrentStateInfo.dataCenter3 == 0) "未接入" else if (commonCurrentStateInfo.dataCenter3 == 1) "在线" else "离线",
                    ...
                    columnCellDataList.add(
                        CommunicationDataCellModel(
                            mData = if (commonCurrentStateInfo.dataCenter4 == 0) "未接入" else if (commonCurrentStateInfo.dataCenter4 == 1) "在线" else "离线",
