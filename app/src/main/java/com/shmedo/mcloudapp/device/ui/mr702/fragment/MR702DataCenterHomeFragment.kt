...
import com.shmedo.mcloudapp.device.viewmodel.state.MR702DataCenterHomeViewModel
...
class MR702DataCenterHomeFragment : BaseIOTDeviceFragment() {
    ...
    private val mStates: MR702DataCenterHomeViewModel by viewModels()
    private val toolbarViewModel: ToolbarViewModel by viewModels()
    private val iotParseManager: IOTParserManager by inject()

    override fun getDataBindingConfig(): DataBindingConfig {
        return DataBindingConfig(R.layout.fragment_mr702_data_center_home, BR.vm, mStates)
