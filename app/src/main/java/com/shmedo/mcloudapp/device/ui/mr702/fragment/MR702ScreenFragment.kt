...
import com.shmedo.mcloudapp.databinding.FragmentMr702ScreenBinding
import com.shmedo.mcloudapp.device.BaseClickProxy
import com.shmedo.mcloudapp.device.BaseIOTDeviceFragment
import com.shmedo.mcloudapp.device.model.BleConnect
import com.shmedo.mcloudapp.device.viewmodel.state.MR702ScreenViewModel
import org.koin.android.ext.android.inject
import timber.log.Timber

class MR702ScreenFragment : BaseIOTDeviceFragment() {
    private val binding: FragmentMr702ScreenBinding by lazy { getBinding() as FragmentMr702ScreenBinding }
    private val mStates: MR702ScreenViewModel by viewModels()
    private val iotParseManager: IOTParseManager by inject()


    override fun getDataBindingConfig(): DataBindingConfig {
        return DataBindingConfig(R.layout.fragment_mr702_screen, BR.vm, mStates)
...
//                        initWirelessData(result.data)
    ...
    companion object {
        fun newInstance() = MR702ScreenFragment()
    }
}