...
import com.shmedo.mcloudapp.databinding.FragmentMr702DiInterfaceBinding
import com.shmedo.mcloudapp.device.BaseClickProxy
import com.shmedo.mcloudapp.device.BaseIOTDeviceFragment
import com.shmedo.mcloudapp.device.viewmodel.state.MR702DIInterfaceViewModel
import com.shmedo.mcloudapp.device.viewmodel.state.MR702InterfaceHomeViewModel

class MR702DIInterfaceFragment : BaseIOTDeviceFragment() {
    private val binding: FragmentMr702DiInterfaceBinding by lazy { getBinding() as FragmentMr702DiInterfaceBinding }
    private val mInterfaceHomeViewModel: MR702InterfaceHomeViewModel by activityViewModels()
    private val mStates: MR702DIInterfaceViewModel by viewModels()


    override fun getDataBindingConfig(): DataBindingConfig {
        return DataBindingConfig(R.layout.fragment_mr702_di_interface, BR.vm, mStates)
...
//        testData()
    ...
    companion object {
        fun newInstance() = MR702DIInterfaceFragment()
    }
}