    ...
    private fun initDOData(doPortParam: MRDOPortParam) {
        launchWithViewLifecycle {
            try {
                ...
                tempList.add(MRDODIPortItem(doPortParam.kstatus1 == "1", "K1"))
                tempList.add(MRDODIPortItem(doPortParam.kstatus2 == "1", "K2"))
                tempList.add(MRDODIPortItem(doPortParam.kstatus3 == "1", "K3"))
                tempList.add(MRDODIPortItem(doPortParam.kstatus4 == "1", "K4"))
    ...
    private fun initDIData(diPortParam: MRDIPortParam) {
        launchWithViewLifecycle {
            try {
                ...
                tempList.add(DeviceStatusInfoGroupItem(""))
                tempList.add(MRDODIPortItem(diPortParam.dstatus1 == "1", "DO1"))
                tempList.add(MRDODIPortItem(diPortParam.dstatus2 == "1", "DO2"))
                tempList.add(MRDODIPortItem(diPortParam.dstatus3 == "1", "DO3"))
                tempList.add(MRDODIPortItem(diPortParam.dstatus4 == "1", "DO4"))
