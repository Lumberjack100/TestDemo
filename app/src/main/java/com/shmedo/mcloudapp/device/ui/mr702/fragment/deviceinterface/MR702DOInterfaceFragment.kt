...
import com.shmedo.mcloudapp.databinding.FragmentMr702DoInterfaceBinding
...
class MR702DOInterfaceFragment : BaseIOTDeviceFragment() {
    private val binding: FragmentMr702DoInterfaceBinding by lazy { getBinding() as FragmentMr702DoInterfaceBinding }
    private val mInterfaceHomeViewModel: MR702InterfaceHomeViewModel by activityViewModels()
    private val mStates: MR702DOInterfaceViewModel by viewModels()


    override fun getDataBindingConfig(): DataBindingConfig {
        return DataBindingConfig(R.layout.fragment_mr702_do_interface, BR.vm, mStates)
