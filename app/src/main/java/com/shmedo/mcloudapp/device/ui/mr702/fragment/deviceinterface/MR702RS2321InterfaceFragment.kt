...
import com.shmedo.mcloudapp.databinding.FragmentMr702Rs2321InterfaceBinding
...
import com.shmedo.mcloudapp.device.viewmodel.state.MR702RS2321InterfaceViewModel

class MR702RS2321InterfaceFragment : BaseIOTDeviceFragment() {
    private val binding: FragmentMr702Rs2321InterfaceBinding by lazy { getBinding() as FragmentMr702Rs2321InterfaceBinding }
    private val mInterfaceHomeViewModel: MR702InterfaceHomeViewModel by activityViewModels()
    private val mStates: MR702RS2321InterfaceViewModel by viewModels()


    override fun getDataBindingConfig(): DataBindingConfig {
        return DataBindingConfig(R.layout.fragment_mr702_rs232_1_interface, BR.vm, mStates)
...
//        testData()
    ...
    companion object {
        fun newInstance() = MR702RS2321InterfaceFragment()
    }
}