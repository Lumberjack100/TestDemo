...
class MR702InterfaceStatusInfoFragment : BaseIOTDeviceFragment() {
    ...
    private fun initSerialPortAdapter() {
        binding.rvSerialPortStatus.setup { rv ->
            ...
            addType<MRInterfaceStatusHeader>(R.layout.item_mr702_interface_status_rv_header)
            addType<MRInterfaceStatusItem>(R.layout.item_mr702_interface_status_rv)
        }
    }

    private fun initAnalogInterfaceAdapter() {
