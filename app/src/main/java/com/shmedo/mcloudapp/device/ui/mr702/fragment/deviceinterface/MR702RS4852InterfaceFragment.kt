...
import com.shmedo.mcloudapp.databinding.FragmentMr702Rs4852InterfaceBinding
...
class MR702RS4852InterfaceFragment : BaseIOTDeviceFragment() {
    private val binding: FragmentMr702Rs4852InterfaceBinding by lazy { getBinding() as FragmentMr702Rs4852InterfaceBinding }
    private val mInterfaceHomeViewModel: MR702InterfaceHomeViewModel by activityViewModels()
    private val mStates: MR702RS4852InterfaceViewModel by viewModels()


    override fun getDataBindingConfig(): DataBindingConfig {
        return DataBindingConfig(R.layout.fragment_mr702_rs485_2_interface, BR.vm, mStates)
