...
import com.shmedo.mcloudapp.databinding.FragmentMr702RainInterfaceBinding
...
class MR702RainInterfaceFragment : BaseIOTDeviceFragment() {
    private val binding: FragmentMr702RainInterfaceBinding by lazy { getBinding() as FragmentMr702RainInterfaceBinding }
    private val mInterfaceHomeViewModel: MR702InterfaceHomeViewModel by activityViewModels()
    private val mStates: MR702RainInterfaceViewModel by viewModels()


    override fun getDataBindingConfig(): DataBindingConfig {
        return DataBindingConfig(R.layout.fragment_mr702_rain_interface, BR.vm, mStates)
