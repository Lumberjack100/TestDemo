...
class MR702RS2322InterfaceFragment : Fragment() {

    companion object {
        fun newInstance() = MR702RS2322InterfaceFragment()
    }

    private val viewModel: MR702RS2322InterfaceViewModel by viewModels()
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_mr702_rs232_2_interface, container, false)
    }
}