...
import com.shmedo.lib.device.base.iot_cmd.model.mr.MRRS232Port2Param
...
//        testData()
    ...
    private fun queryInfo() {
        ...
        val command = IOTCommandUtil.getCommand(IOTCommandType.MD_MR_GET_RS232_PORT2_PARAM)
        commandItems.add(command)
        sendCommandFromCmdList(isStartTimeoutJob = true)
    }
    ...
    override fun setResultData(cmdStr: String) {
        when (IOTCommandUtil.extractCommandType(cmdStr)) {
            IOTCommandType.MD_MR_GET_RS232_PORT2_PARAM -> {
    ...
    private fun testData() {
        val sensorParam = MRRS232Port2Param(
            switch = "1",
            daddr = "1",
            baud = "9600",
            databit = "8",
