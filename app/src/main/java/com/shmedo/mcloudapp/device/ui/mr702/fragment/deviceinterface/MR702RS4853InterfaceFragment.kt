...
class MR702RS4853InterfaceFragment : Fragment() {

    companion object {
        fun newInstance() = MR702RS4853InterfaceFragment()
    }

    private val viewModel: MR702RS4853InterfaceViewModel by viewModels()
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_mr702_rs485_3_interface, container, false)
    }
}