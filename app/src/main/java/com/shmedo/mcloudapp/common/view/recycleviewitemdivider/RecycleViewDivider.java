package com.shmedo.mcloudapp.common.view.recycleviewitemdivider;
...
public class RecycleViewDivider extends RecyclerView.ItemDecoration
{
    ...
    private boolean isDrawLastLine = true;//是否绘制最后一条分割线, LinearLayoutManager.VERTICAL时为最下面一条线，LinearLayoutManager.HORIZONTAL为最右面一条线

    /**
     * 注意：列表的方向 LinearLayoutManager.VERTICAL或LinearLayoutManager.HORIZONTAL
     */
    ...
    /**
     * 是否绘制最后一条分割线:<br/>
     * LinearLayoutManager.VERTICAL时为最下面一条线，LinearLayoutManager.HORIZONTAL为最右面一条线
     */
    ...
    private void drawHorizontal(Canvas canvas, RecyclerView parent)
    {
        ...
        final int childSize = isDrawLastLine ? parent.getChildCount() : parent.getChildCount() - 1;
