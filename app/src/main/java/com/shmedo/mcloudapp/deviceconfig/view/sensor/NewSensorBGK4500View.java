 ...
 */
public class NewSensorBGK4500View extends FrameLayout {
    ...
    public NewSensorBGK4500View(@NonNull Context context) {
        this(context, null);
    }

    public NewSensorBGK4500View(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NewSensorBGK4500View(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        //关联布局文件
        ((LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.new_bgk_osmometer_config, this, true);
