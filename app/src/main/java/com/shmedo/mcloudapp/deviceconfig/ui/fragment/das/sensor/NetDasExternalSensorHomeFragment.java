 ...
 * 描述：   DAS扩展传感器配置页面
 */
public class NetDasExternalSensorHomeFragment extends BaseNetIotCommunicateFragment {
    ...
    public static NetDasExternalSensorHomeFragment newInstance(ProjectDeviceInfo projectDeviceInfo) {
        NetDasExternalSensorHomeFragment fragment = new NetDasExternalSensorHomeFragment();
    ...
    private void processItemClick(int position) {
        ...
        if (curSensorItem.isAddButton()) {
            ...
            SensorType sensorType = getSensorTypeByCollectorCode(collectorCode);
...
//        super.onQueryCmdResponseResultSuccess(queryCmdResult);
    ...
    private SensorType getSensorTypeByCollectorCode(String code) {

        switch (CollectorModel.value(code)) {
            case VW08:
