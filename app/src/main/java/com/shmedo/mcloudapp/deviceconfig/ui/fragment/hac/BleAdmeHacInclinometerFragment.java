...
import com.shmedo.mcloudapp.deviceconfig.view.hac.AdmeHacInclinometerView;
 ...
 * 创建者:   gonghe <br/>
 * 创建时间:  2022/7/19 <br/>
 * 描述：     ADME HAC 测斜仪参数配置页面
 */
public class BleAdmeHacInclinometerFragment extends BaseUSRBleIotCommunicateFragment {
    @BindView(R.id.hacInclinometerView)
    AdmeHacInclinometerView hacInclinometerView;

    @BindView(R.id.maskLayerLayout)
    ViewGroup maskLayerLayout;

    public static BleAdmeHacInclinometerFragment newInstance() {
        return new BleAdmeHacInclinometerFragment();
    }

    @Override
    protected int getLayoutId() {
        return R.layout.adme_hac_inclinometer_fragment;
    }
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.ll_low_power_mode) {
            ...
            String command = hacInclinometerView.getSetCommand();
    ...
    private void setResultData(final String cmdStr) {
        ...
        switch (type) {
            case ADME_MD_GET_INCLINOMETER: {//获取ADME的测斜仪配置参数
                ...
                hacInclinometerView.admeInclinometerInfo = commandResult.getResult();
                hacInclinometerView.initParamConfigInfo();
            }
            break;
    ...
    protected void onEditableChanged(boolean isEditable) {
        hacInclinometerView.onEditableChanged(isEditable);
    }
}
