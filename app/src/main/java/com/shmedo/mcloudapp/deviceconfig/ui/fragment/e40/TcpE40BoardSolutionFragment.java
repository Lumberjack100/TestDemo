 ...
 * 创建者:   gonghe <br/>
 * 创建时间:  3/5/21 <br/>
 * 描述：      E40 TCP模式板卡解算配置页面
 */
public class TcpE40BoardSolutionFragment extends BaseTcpIotCommunicateFragment {
    ...
    public static TcpE40BoardSolutionFragment newInstance() {
        TcpE40BoardSolutionFragment fragment = new TcpE40BoardSolutionFragment();
        return fragment;
    }
