 ...
 */
public class NewSensorVWP03View extends FrameLayout {
    ...
    public NewSensorVWP03View(@NonNull Context context) {
        this(context, null);
    }

    public NewSensorVWP03View(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NewSensorVWP03View(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        //关联布局文件
        ((LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.new_vwp_osmometer_config, this, true);
