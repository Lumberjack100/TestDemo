 ...
 * 描述：    默认的 BLE 设备的首页
 */
public class BleIotDefaultHomeFragment extends BaseUSRBleIotCommunicateFragment {
    ...
    public static BleIotDefaultHomeFragment newInstance(DiscoveredBluetoothDevice device) {
        BleIotDefaultHomeFragment fragment = new BleIotDefaultHomeFragment();
...
//                        hideProgressBar();
    ...
    private void initConfigModuleData() {
        ...
        configModule = new ConfigModule(R.drawable.ic_device_reboot, "指令调试", "自定义指令调试输出");
        configModuleList.add(configModule);
    }
...
//                stopDefaultProgress(AppContants.MsgWhat.MSG_DEFAULT);
    ...
    private void updateHeadInfo() {
        ...
        mTvDeviceName.setText(TextUtils.isEmpty(deviceInfo.getDeviceName()) ? sn : deviceInfo.getDeviceName());
