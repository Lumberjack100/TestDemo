...
public abstract class BaseDeviceConnectActivity extends BaseActivity {
    ...
    private void checkBluetoothPermissions(){
        XPermissionUtils.requestPermissionsResult(BaseDeviceConnectActivity.this, 200, new String[]{
                ...
                new XPermissionUtils.OnPermissionListener() {
                    ...
                    public void onPermissionDenied(List<String> deniedPermissions) {
                        boolean allNeverAskAgain = XPermissionUtils.isAllNeverAskAgain(BaseDeviceConnectActivity.this, deniedPermissions);
                        // 所有的权限都被勾上不再询问时，跳转到应用设置界面，引导用户手动打开权限
                        if (allNeverAskAgain) {
                            XPermissionUtils.showRefusePermissionDialog(BaseDeviceConnectActivity.this, GlobalUtil.getString(R.string.message_permission_bluetooth_location_rational));
                        } else {
