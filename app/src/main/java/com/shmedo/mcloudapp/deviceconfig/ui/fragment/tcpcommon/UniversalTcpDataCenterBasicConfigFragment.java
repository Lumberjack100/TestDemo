 ...
 * 创建者:   gonghe <br/>
 * 创建时间:  3/4/21 <br/>
 * 描述：      通用TCP模式数据中心基本参数配置页面
 */
public class UniversalTcpDataCenterBasicConfigFragment extends BaseTcpIotCommunicateFragment {
    ...
    public static UniversalTcpDataCenterBasicConfigFragment newInstance(ServerNumber serverNumber, String status) {
        UniversalTcpDataCenterBasicConfigFragment fragment = new UniversalTcpDataCenterBasicConfigFragment();
