 ...
 * 创建者:   gonghe <br/>
 * 创建时间:  3/5/21 <br/>
 * 描述：      E40 TCP模式GPS 工作参数配置页面
 */
public class TcpE40GpsWorkParamFragment extends BaseTcpIotCommunicateFragment {
    ...
    public static TcpE40GpsWorkParamFragment newInstance() {
        return new TcpE40GpsWorkParamFragment();
    }
