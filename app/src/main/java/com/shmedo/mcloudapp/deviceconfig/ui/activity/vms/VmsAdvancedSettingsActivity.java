 ...
 * 描述：     Vms 网关高级设置页面
 */
public class VmsAdvancedSettingsActivity extends BaseConfigFragmentContainerActivity {

    public static void startActivity(Context context, ProjectDeviceInfo projectDeviceInfo) {
        Intent intent = new Intent(context, VmsAdvancedSettingsActivity.class);
