 ...
 * 描述：     雨量终端参数配置
 */
public class BleRN20ParamSettingFragment extends BaseUSRBleIotCommunicateFragment {
    ...
    public static BleRN20ParamSettingFragment newInstance() {
        return new BleRN20ParamSettingFragment();
    }
    ...
    private void processSaveTerminalCollector() {
        ...
        entity.setSn(MCloudApp.getCurDeviceToken());
