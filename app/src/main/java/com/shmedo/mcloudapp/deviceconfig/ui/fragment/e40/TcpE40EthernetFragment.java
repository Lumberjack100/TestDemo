 ...
 * 创建者:   gonghe <br/>
 * 创建时间:  3/5/21 <br/>
 * 描述：      E40 TCP模式有线网络配置页面
 */
public class TcpE40EthernetFragment extends BaseTcpIotCommunicateFragment {
    ...
    public static TcpE40EthernetFragment newInstance() {
        TcpE40EthernetFragment fragment = new TcpE40EthernetFragment();
        return fragment;
    }
