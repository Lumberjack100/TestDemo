...
class MRRS485Port3SensorParamParser: IOTCommandParser<MRRS485Port3SensorParam> {
        ...
        override fun parseKeyValueMap(keyValueMap: Map<String, String>): MRRS485Port3SensorParam {
            return MRRS485Port3SensorParam().apply {
                ...
                rlevel1 = keyValueMap.getOrDefault("rlevel1", rlevel1)
                rlevel2 = keyValueMap.getOrDefault("rlevel2", rlevel2)
                rlevel3 = keyValueMap.getOrDefault("rlevel3", rlevel3)
                wlevel1 = keyValueMap.getOrDefault("wlevel1", wlevel1)
                wlevel2 = keyValueMap.getOrDefault("wlevel2", wlevel2)
                wlevel3 = keyValueMap.getOrDefault("wlevel3", wlevel3)
                type = keyValueMap.getOrDefault("type", type)
                stime = keyValueMap.getOrDefault("stime", stime)
            }
        }

        override val commandType: IOTCommandType = IOTCommandType.MR_MD_GET_RS485_PORT3_SENSOR_PARAM
}