...
data class MRRS485Port2SensorParamEntity(
    ...
    val polyavalue: String = IOTConstants.NULL_KEY,//多项式系数A值
    val polybvalue: String = IOTConstants.NULL_KEY,//多项式系数B值
    val polycvalue: String = IOTConstants.NULL_KEY,//多项式系数C值
){
