...
data class UDCurrentStateInfo(
    ...
    @Json(name = "adxl_sta")
    val accelerometerStatus: String = IOTConstants.NULL_KEY, //倾角加速度计 0：正常 -2：数据异常  -3：模块异常
    @Json(name = "4G_sta")
    val _4gStatus: String = IOTConstants.NULL_KEY, //4G模块状态   0：正常 -2：数据异常  -3：模块异常
    @Json(name = "bt_sta")
    ...
    @Json(name = "ath_sta")
    val athStatus: String = IOTConstants.NULL_KEY, //温湿度模块状态   0：正常 -2：数据异常  -3：模块异常
    @Json(name = "alt")
