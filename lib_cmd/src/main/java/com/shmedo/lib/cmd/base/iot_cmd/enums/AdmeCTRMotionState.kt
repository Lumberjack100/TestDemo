 ...
 * 描述：    设备测量过程状态枚举
 */
enum class AdmeCTRMotionState(val code: String, val description: String, val simpleDesc: String) {
    NOZZLE_WAITING("0", "上拉至管口", "上拉至管口"),
    PAIR_SETTING_PARAM("1", "磁开关触发,测斜仪配对,设置参数", "测斜仪配对"),
    DOWN("2", "测斜仪下放", "下放中"),
