...
class AlarmReportIntervalInfoParser : IOTCommandParser<AlarmReportIntervalInfo> {
    override fun parseKeyValueMap(keyValueMap: Map<String, String>): AlarmReportIntervalInfo {
    ...
    override val commandType: IOTCommandType = IOTCommandType.MD_GET_ALRAM_BROADCAST_REPORT_INTERVAL
}