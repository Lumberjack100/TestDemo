...
enum class NewDataCenterPlatform(
    ...
    MEDO_IOT_PLATFORM("米度物联平台", "2", "mqtthub.shmedo.cn", "47.96.80.48", "1883"),
    ...
    CHONGQING_DISASTER_PLATFORM("重庆地灾平台", "7", "183.66.66.31", "183.66.66.31", "1883"),
    GUANGDONG_WATER_PLATFORM("广东水文平台", "8", "iot.gdwater.gov.cn", "210.76.75.21", "8883"),
    GUANGXI_WATER_PLATFORM("广西水文平台", "9", "222.216.6.174", "222.216.6.174", "8076"),
    HUBEI_WATER_PLATFORM("湖北水文平台", "10", "183.95.190.143", "183.95.190.143", "9095"),
    HUBEI_ECO_PLATFORM("湖北生态流量平台", "11", "183.95.190.143", "183.95.190.143", "8094"),
    ...
    companion object {
        ...
        fun valueByPlatType(
            ...
            val normalizedIp = ipOrDomain?.trim()?.takeUnless { it.isEmpty() }
            ...
            return matchedByType.firstOrNull { (it.ip == normalizedIp || it.domain == normalizedIp) && it.port == normalizedPort }
                ?: matchedByType.first()
        }
    }
