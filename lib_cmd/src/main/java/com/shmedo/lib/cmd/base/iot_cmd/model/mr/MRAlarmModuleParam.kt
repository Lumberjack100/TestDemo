...
data class MRAlarmModuleParam(
    ...
    var holdtime1: String = "",               // 一级报警报警持续时间 数值≥1，单位：分钟
    var holdtime2: String = "",               // 二级报警报警持续时间 数值≥1，单位：分钟
    var holdtime3: String = "",               // 三级报警报警持续时间 数值≥1，单位：分钟
    var holdtime4: String = "",               // 四级报警报警持续时间 数值≥1，单位：分钟
    var gaptime1: String = "",                // 一级报警间隔时间 数值≥1，单位：分钟
    var gaptime2: String = "",                // 二级报警间隔时间 数值≥1，单位：分钟
    var gaptime3: String = "",                // 三级报警间隔时间 数值≥1，单位：分钟
    var gaptime4: String = "",                // 四级报警间隔时间 数值≥1，单位：分钟
