 ...
 */
@IOTParser
class AdmeHacExecutiveAgencyInfoParser : IOTCommandParser<AdmeExecutiveAgencyInfo> {
    ...
    override val commandType: IOTCommandType = IOTCommandType.ADME_HAC_MD_GET_EXECUTIVE_AGENCY
}