...
class MRDataCenterStatusParser : IOTCommandParser<MRDataCenterStatus> {
    ...
    override fun parseInstance(keyValueMap: Map<String, String>): MRDataCenterStatus {
    ...
    override fun commandType(): IOTCommandType = IOTCommandType.MD_MR_GET_DATA_CENTER_STATUS
}