...
class DasCollectorInfoParser: IOTCommandParser<DasCollectorInfo> {
    override fun parseInstance(keyValueMap: Map<String, String>): DasCollectorInfo {
    ...
    override fun commandType(): IOTCommandType = IOTCommandType.DAS_MD_GET_COLLECTOR_CONTROL
